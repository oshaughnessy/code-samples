# $Id: WRT54GP2.pm,v 1.3 2006/09/06 22:26:11 root Exp $

package ATA::WRT54GP2;
use base qw(ATA);
...
use constant MODEL_ID     => 4;
# Path to all config files for this model of ATA
use constant CFG_DIR      => '/usr/local/www/ata/wrt54gp2';
# Path to an individual ATA's text config.  %s will be replaced w/the MAC
use constant TEXT_CFG     => '/usr/local/www/ata/wrt54gp2/%s.xml';
...
use constant BIN_CMD      => '/usr/bin/gzip -f -c '.
                             '/usr/local/www/ata/wrt54gp2/%s.xml >'.
                             '/usr/local/www/ata/wrt54gp2/%s.xml.gz';
...
# 
# $Log: WRT54GP2.pm,v $
# Revision 1.3  2006/09/06 22:26:11  root
# merged in SPA2100.pm corrections to support changing codecs in xml files
#
