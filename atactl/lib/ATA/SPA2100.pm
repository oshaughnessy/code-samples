# $Id: SPA2100.pm,v 1.4 2006/07/25 22:43:43 root Exp shaug $
...
use constant MODEL_ID     => 3;
# Path to all config files for this model of ATA
use constant CFG_DIR      => '/usr/local/www/ata/spa2100';
# Path to an individual ATA's text config.  %s will be replaced w/the MAC
use constant TEXT_CFG     => '/usr/local/www/ata/spa2100/%s.xml';
...
use constant BIN_CMD      => '/usr/bin/gzip -f -c '.
                             '/usr/local/www/ata/spa2100/%s.xml >'.
                             '/usr/local/www/ata/spa2100/%s.xml.gz';
